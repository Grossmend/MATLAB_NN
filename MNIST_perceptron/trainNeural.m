...
% ошибки скрытого слоя, распределенные пропорц. весам связей
hidden_errors = who'*output_errors;

% обновление весовых коэффициентов между скрытым слоем и выходными параметрами (по Гауссу)
who = who + lr .* (output_errors .* final_outputs .* (1 - final_outputs)) * hidden_outputs';
 
% обновление весовых коэффициентов между входными параметрами и скрытым слоем (по Гауссу)
